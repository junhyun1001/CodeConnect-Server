...
public class ProfileController {
    ...
    public ResponseDto<Object> getProfile(@AuthenticationPrincipal String email, @PathVariable String nickname){
        return profileService.showProfile(email, nickname);
    }
